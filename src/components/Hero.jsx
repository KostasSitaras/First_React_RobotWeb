  ...
  return (
    <section className="grid min-h-[calc(100vh-96px)] w-full items-center gap-14 px-4 py-14 sm:px-5 lg:grid-cols-[1.25fr_0.75fr] lg:px-8 2xl:px-10">
      <div data-reveal="up" className="max-w-4xl">
        ...
        <h1 className="text-5xl font-semibold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl 2xl:text-8xl">
          I build practical,
      ...
      <aside
        data-reveal="left"
        className="interactive-card delay-2 rounded-3xl border border-white/10 bg-white/[0.035] p-7 shadow-lg lg:p-8"
      >
