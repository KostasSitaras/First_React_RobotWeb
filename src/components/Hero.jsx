...
const Hero = () => {
  return (
    <section className="story-hero site-gutter relative flex w-full items-center overflow-hidden">
      <div className="story-hero-grid w-full">
        <div data-reveal="up" className="relative z-10 max-w-[980px]">
          <div className="story-hero-status mb-8 flex flex-wrap items-center gap-3">
          ...
          <p className="story-hero-name mb-4 text-sm font-medium uppercase tracking-[0.22em] text-orange-200 sm:text-base">
          ...
          <p className="story-hero-description mt-7 max-w-3xl text-base leading-7 text-gray-400 sm:text-lg sm:leading-8">
          ...
          <div className="story-hero-actions mt-7 grid gap-3 sm:mt-9 sm:flex sm:flex-wrap">
            <Link
              to="/projects"
          ...
          <div className="story-hero-technologies mt-9 flex flex-wrap items-center gap-2">
